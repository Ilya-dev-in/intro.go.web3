...
import { getEmailCaipNetworks, getTransport, getWalletConnectCaipNetworks, parseWalletCapabilities, requireCaipAddress } from './utils/helpers.js';
...
export class WagmiAdapter {
    constructor(configParams) {
        ...
        const transportsArr = this.wagmiChains.map(chain => [
            chain.id,
            getTransport({ chain: chain, projectId: configParams.projectId })
        ]);
